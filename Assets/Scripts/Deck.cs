...
public class Deck : MonoBehaviour {
	...
	public void MakeCards(){
				...
				for (int i=0; i<cardNames.Count; i++) {
						...
						cgo.transform.localPosition = new Vector3 ((i % 13) * 3, (i / 13) * 4, 0); //stacks cards
						...
						if(card.def.face != ""){
							...
							tGO.tranform.localPosition = Vector3.zero;
							tGO.name = "face";
						}
						...
						card.faceUp = false; //use property of card
